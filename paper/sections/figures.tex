...
\begin{figure}[htbp]
  ...
  \caption[Pipeline and scaling]{%
    ...
    by instrument family; time-to-finish stays within a few hours from a
    handful to thousands of files because per-file work is parallelised.
  }
...
\begin{figure}[htbp]
  ...
  \caption[Cell-line reanalyses]{%
    \textbf{Independent reanalysis of public DIA datasets recovers as many
    or more identifications than the original deposits.}
    ...
    Per-cohort detail in Additional file~1: Figs.~S5--S13.
  }
