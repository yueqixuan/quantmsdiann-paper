...
\begin{figure}[htbp]
  ...
  \begin{minipage}{\textwidth}
    ...
    \end{minipage}
  \end{minipage}
  \caption[Cell-line and spatial reanalyses]{%
    \textbf{Independent reanalysis of public DIA datasets, spanning bulk cell
    lines, single cells, and spatial proteomics, recovers comparable or
    greater identification depth than the original deposits.}
