...
By design, \quantmsdiann{} ends at harmonised quantification, leaving batch correction, cell-type assignment, and differential-abundance analysis to downstream packages such as scp~\cite{vanderaa2023} that read its \qpx{} or MSstats output directly; in this sense it complements existing single-cell DIA workflows rather than competing with them. 
%% [end discussion]
