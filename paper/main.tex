...
The newer 2.5.1-enterprise version increased total identifications: on HeLa Astral, total precursors rose from 22{,}531 to 25{,}145 ($+12$\%) and protein groups from 4{,}134 to 4{,}735 ($+15$\%), with the gain holding per cell (Fig.~\ref{fig:single-cell}a). On the deeper A549/H460 cohort the reanalysis reproduced the original study's Astral single-cell depth~\cite{bubis2025astral}, reaching a median of 3{,}366 protein groups per cell and up to 5{,}567 in the deepest cells, with total precursors rising from 61{,}502 to 69{,}246 ($+13$\%); here the total protein-group count was already saturated and essentially unchanged across builds (7{,}695 versus 7{,}426), so the version effect is concentrated in precursor depth rather than protein count.
