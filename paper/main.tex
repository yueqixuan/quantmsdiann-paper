...
Across all the public DIA deposits reanalysed in this study --- single-cell, bulk cell-line and spatial --- reprocessing with a current \texttt{DIA-NN} build recovered more protein groups than the originally deposited or published analysis on every deposit, and more precursors wherever the original analysis was itself \texttt{DIA-NN} (Fig.~\ref{fig:reanalysis}).
...
Per-cohort completeness, peptide-per-protein distributions, accession overlap and per-cell-line missingness are provided in Supplementary Note~6 (Figs.~S4--S13), which also include an NK-cell Fe-NTA phosphoproteomics reanalysis (PXD049692; $23$\% more phosphopeptide backbones, 5{,}240 versus 4{,}254, at 1\% FDR). A spatial Deep Visual Proteomics cohort of MYCN-amplified neuroblastoma (PXD064049) was likewise reanalysed and recovered more identifications than the original \texttt{DIA-NN}~1.8.1 analysis (precursors 20{,}412 versus 16{,}518, $+24$\%; protein groups 3{,}067 versus 2{,}882, $+6$\%).
%% [end results]
