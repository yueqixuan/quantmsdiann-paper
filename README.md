...
|---|---|---|---|
| **F1a — ProteoBench parity** | quantmsdiann matches DIA-NN GUI on community benchmarks | [`figure_quantmsdiann_benchmarks_vs_proteobench.py`](analysis/figure_quantmsdiann_benchmarks_vs_proteobench.py) | `quantmsdiann_benchmarks/main_diann_quantmsdiann_parity.svg`, `main_benchmarks_overview.svg`, `main_benchmarks_precursors.svg`, `supp_vs_proteobench_min3.svg`, `supp_vs_proteobench_matched_min3.svg` |
| **F1b — ID vs accuracy scatter** | quantmsdiann matches accuracy too, not just IDs | [`figure_id_vs_epsilon.py`](analysis/figure_id_vs_epsilon.py) (consumes [`proteobench_metrics.py`](analysis/proteobench_metrics.py)) | `quantmsdiann_benchmarks/main_id_vs_epsilon.svg` |
...
| **F3-version — Cell-line cross-version progression** | DIA-NN releases improve IDs on real cohorts | [`figure_cell_line_version_progression.py`](analysis/figure_cell_line_version_progression.py) — consumer only; needs cluster reruns per [spec #13](docs/superpowers/specs/2026-05-20-experiment-13-cell-line-version-sweep.md) | `combined/cell_line_version_progression.svg` (rendered only when cross-version matrices are staged) |
